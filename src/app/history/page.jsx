...
export default function HistoryPage() {
    ...
    return <div className="flex flex-col p-8 gap-0 items-start justify-start">
        <h2 className="justify-start text-zinc-200 text-xl font-medium font-['Inter']">Generation History</h2>
        <HistoryImageList images={demoImages} />
    </div>
}